...
from .views import ProductListCreateAPIView, ProductRetrieveUpdateDestroyAPIView, LabelListCreateAPIView, LabelRetrieveUpdateDestroyAPIView, CartListView, CartDetailView
